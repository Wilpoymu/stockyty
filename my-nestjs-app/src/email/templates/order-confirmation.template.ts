...
<body>
    <div class="container">
        ...
        <p>Puedes seguir el estado de tu pedido en cualquier momento:</p>
        <a href="${trackingLink}" class="button">Seguir Mi Pedido</a>
        
        <p class="footer">Si tienes alguna pregunta sobre tu pedido, no dudes en contactar con nuestro servicio de atención al cliente.</p>
